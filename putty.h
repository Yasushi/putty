...
struct iso2022struct
{
  ...
  struct g
  {
    enum
    {
      ...
      JISX0213_1, JISX0213_2, MS_KANJI,
      ...
      NATS_SECONDARY_FINLAND_SWEDEN, NATS_PRIMARY_DENMARK_NORWAY,
      NATS_SECONDARY_DENMARK_NORWAY, SEN850200ANNB, SEN850200ANNC, DIN66003,
      ISO646_PORTUGUESE, ISO5427, NFZ62010_1973, LATIN_GREEK_HONEYWELL_BULL,
      ISO5428, ISO646_ITALIAN, ISO646_SPANISH, ECMA_GREEK, LATIN_GREEK, 
      UTF8,
    } type;
    int len;
  } g0, g1, g2, g3, *gl, *gr, *ssl, *ssr, lgr;
